...
def initialize_adventures():
    ...
    cursor.execute('INSERT INTO adventure_options (adventure_id, option_id) VALUES (?, ?)', (left_path_id, cave_id))
    cursor.execute('INSERT INTO adventure_options (adventure_id, option_id) VALUES (?, ?)', (left_path_id, hilltop_id))

    cursor.execute('INSERT INTO adventures (description) VALUES (?)', ('Decides cruzar el río nadando.',))
    swim_id = cursor.lastrowid

    cursor.execute('INSERT INTO adventures (description) VALUES (?)', ('Sigues el curso del río hacia una cascada.',))
    waterfall_id = cursor.lastrowid

    cursor.execute('INSERT INTO adventure_options (adventure_id, option_id) VALUES (?, ?)', (right_path_id, swim_id))
    cursor.execute('INSERT INTO adventure_options (adventure_id, option_id) VALUES (?, ?)',
    ...
    cursor.execute('INSERT INTO adventure_options (adventure_id, option_id) VALUES (?, ?)', (cave_id, treasure_id))
    cursor.execute('INSERT INTO adventure_options (adventure_id, option_id) VALUES (?, ?)', (hilltop_id, lost_id))
    cursor.execute('INSERT INTO adventure_options (adventure_id, option_id) VALUES (?, ?)', (swim_id, boat_id))
    cursor.execute('INSERT INTO adventure_options (adventure_id, option_id) VALUES (?, ?)', (waterfall_id, fall_id))
